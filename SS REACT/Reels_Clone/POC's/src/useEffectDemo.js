...
// UseEffect eak baar mounting ke time
// UseEffect[] baar baar har update ke baad
// UseEffect[state variable] jab oos state variable mei change aayega tabh chalega

// UseEffect runs after return statement
...
function InputBox(prop) {
  ...
  // Next UseEffect ke chalne se pehle cleanup chalta hei in case of useeffect[state variable] && useEffect
  // useEffect[] wale kaa clean up unmounting/destroy ke baad chalta hei
