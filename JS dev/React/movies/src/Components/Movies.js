...
export default class Movies extends Component {
    ...
    loadMoreMovies = async() =>{
        ...
        const res = await axios.get(`https://api.themoviedb.org/3/movie/popular?api_key=3490bd9575e6faf1f96e4aa9a685b8f8&language=en-US&page=${this.state.currPage}`);
        let data = res.data;
        this.setState({
    ...
    return (
        <>
            {  
                ...
                :
                <div className = "movies-list text-center" style = {{padding : '20px'}}>
                    {
                        this.state.movies.map((movieObj) =>(
                            <div className="card movies-card text-center">
